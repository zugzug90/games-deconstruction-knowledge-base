...
- Также в этой игре все уровни начиная со второго имеют дополнительные уровни сложности, которые игрок может закрыть - меняется расстановка и ростер предметов, увеличивается колчество, которое нужно найти, уровни: легко, средний, сложно, эксперт. После всех их прохождений открывается ещё один с неким секретным предметом.
